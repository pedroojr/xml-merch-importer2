  ...
  return (
    <div className="space-y-4">
        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2">
            <Switch
              ...
              onCheckedChange={setShowOnlyUnconfirmed}
            />
      ...
      {sortedBrands.map(([brand, brandProducts]) => {
        const filteredProducts = showOnlyUnconfirmed
          ? brandProducts.filter(p => !isProductConfirmed(p))
          : brandProducts;
                  ...
                  return (
                    <TableRow 
                      ...
                      className={`
                        ...
                        hover:bg-slate-100 transition-colors ${confidenceClass}
                      `}
                    >
